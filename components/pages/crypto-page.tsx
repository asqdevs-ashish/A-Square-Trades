    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8">
        <motion.div
          ...
          className="mb-8"
        >
          <h1 className="text-4xl font-bold tracking-tight">Cryptocurrency</h1>
          <p className="mt-2 text-muted-foreground">
            Trade Bitcoin, Ethereum, and thousands of other cryptocurrencies
          </p>
        </motion.div>
...
function CryptoCard({ asset, index }: CryptoCardProps) {
  ...
  return (
    ...
    >
      <Link href={`/?asset=${asset.id}&market=crypto`}>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-[var(--neon-blue)]/20 to-[var(--neon-purple)]/20">
